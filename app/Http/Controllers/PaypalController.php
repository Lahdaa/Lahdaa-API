        ...
        try{
            if ($request->input('paymentId') && $request->input('PayerID')) {
                ...
                if ($response->isSuccessful()) {
                    ...
                    //Save activity trail
                    save_activity_trail($user_id, 'Course payment', 'User ('.$user_id.') payed via paypal and enroled for a course with id ('.$course_id.')',
                        get_current_date_time());
                ...
                return response()->json([
                    'message' => 'paymentId and PayerID cannot be empty.',
